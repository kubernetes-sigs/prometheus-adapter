...
require (
	...
	sigs.k8s.io/metrics-server v0.6.1-0.20230426085618-18da401d7a2d
)

replace sigs.k8s.io/custom-metrics-apiserver => github.com/jorturfer/custom-metrics-apiserver v1.23.1-0.20230426201446-c950c89a5fcd
