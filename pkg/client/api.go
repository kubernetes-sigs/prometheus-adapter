...
func NewGenericAPIClient(client *http.Client, baseURL *url.URL, headers map[string][]string) GenericAPIClient {
...
func NewClient(client *http.Client, baseURL *url.URL, headers map[string][]string) Client {
